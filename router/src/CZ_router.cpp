...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// \file XY_router.cpp
/// \brief Implements CZ routing algorithm
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////
void CZ_router::setID(UI id_tile)
{
    id = id_tile;
    initialize();
}
...
////////////////////////////////////////////////
UI CZ_router::calc_next(UI ip_dir, ULL source_id, ULL dest_id)
{
		cout<<"Node: "<<id<<", Congest: "<<congCount<<endl;
    int xco = id / num_cols;
    int yco = id % num_cols;
...
void CZ_router::initialize()
{
	congCount,congestN,congestS,congestE,congestW = 0;
}
